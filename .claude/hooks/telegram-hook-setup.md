...
**Expected output:**
```
Telegram notification sent for Stop event in project claude-anti-chaotic
```
...
```
🚀 Claude Anti-Chaotic Task Completed

📅 Time: 2026-01-21 14:30:45
📁 Project: claude-anti-chaotic
🔧 Total Operations: 15
🆔 Session: abc12345...
...
📍 Location: `C:\Users\user\projects\claude-anti-chaotic`
```
...
**Example notification:**
```
🤖 Claude Anti-Chaotic Subagent Completed

📅 Time: 2026-01-21 14:35:20
📁 Project: claude-anti-chaotic
🔧 Agent Type: planner
🆔 Session: abc12345...
...
📍 Location: `C:\Users\user\projects\api-server`
```
...
📍 Location: `C:\Users\user\projects\frontend-app`
```
...
📍 Location: `C:\Users\user\projects\microservice`
```
